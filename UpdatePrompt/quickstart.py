...
# Main function to execute the script: initializes credentials, fetches content, processes topics, and saves to JSON.
def main():
    ...
    print("Data saved to prompts.json")
